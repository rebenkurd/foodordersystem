  ...
  <div class="main_container main_menu_open">
    ...
    <div class="home_pass hidden-xs">
      <ul>
        ...
        <li class="bring_right"><a href="manage_users.php?source=view_all_admins&page=1">پێشاندانی هەموو بەڕێوبەرەکان</a></li>
      </ul>
    </div>
    <!--/End system bath-->
    <div class="page_content">
      <h1 class="heading_title">پێشاندانی هەموو بەڕێوبەرەکان</h1>
      <!--Start status alert-->
      <?php
      echo SuccessMessage();
      echo ErrorMessage();
            ...
            <table class="">
              ...
              <tbody class="overlay-scrollbar">
                ...
                if (isset($_GET["page"])) {
                  ...
                  $query = "SELECT * FROM tb_users WHERE type_id='1' AND recycle='0' LIMIT $ShowPage,5";
                    ...
                    <?php
                     ...
                     <?php }?>
                      ...
                      <td>
                        ...
                        <a href="manage_users.php?source=view_all_admins&id=<?php echo htmlentities($Id); ?>" class="fas fa-trash text-danger" data-toggle="tooltip" data-placement="top" title="سرینەوە"></a>
                      </td>
                    </tr>
                <?php
                  }
                } else {
                  echo '<tr><td colspan="9" class="text-danger text-center" >هیچ بەرێوبەرێکمان نیە</td></tr>';
                }
      ...
      <nav class="text-center">
        <ul class="pagination">
          ...
          ?>
              <li>
                <a aria-label="Previous" href="manage_users.php?source=view_all_admins&page=<?php echo htmlentities($i - 1); ?>"><span aria-hidden="true">»</span></a>
              </li>
          <?php }
          } ?>
          ...
          <?php
          global $con;
          $query = "SELECT COUNT(*) FROM tb_users WHERE type_id='1' AND recycle='0'";
          $sql = mysqli_query($con, $query);
          ...
          for ($i = 1; $i <= $PostPagination; $i++) {
            if (isset($Page)) {
          ?>
              <li class="page-item active"><a href="manage_users.php?source=view_all_admins&page=<?php echo htmlentities($i); ?>"><?php echo htmlentities($i); ?> <span class="sr-only">(current)</span></a></li>
          <?php
          ...
          ?>
              <li>
                <a aria-label="Next" href="manage_users.php?source=view_all_admins&page=<?php echo htmlentities($i + 1); ?>"><span aria-hidden="true">«</span></a>
              </li>
          <?php }
          } ?>
        </ul>
