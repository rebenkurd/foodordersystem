          ...
          <div class="main_container main_menu_open">
            ...
            <div class="home_pass hidden-xs">
              <ul>
                ...
                <li class="bring_right">
                  <a href="">الصفحة الرئيسية للوحة تحكم الموقع</a>
                </li>
              </ul>
            </div>
            <!--/End system bath-->
            <div class="page_content">
              <div class="page_content">
                <div class="quick_links text-center">
                  ...
                  <a
                    href="view_all_users.html"
                    style="background-color: #8e44ad"
                  >
                    <h4>عرض الاعضاء</h4>
                  </a>
                  <a
                    href="add_new_topic.html"
                    style="background-color: #d35400"
                  >
                    <h4>إضافة موضوع</h4>
                  </a>
                  <a
                    href="add_new_photo.html"
                ...
                <div class="home_statics text-center">
                  ...
                  <div style="background-color: #34495e">
                    <span
                      class="bring_right glyphicon glyphicon-phone-alt"
                    ></span>
                  ...
                  <div style="background-color: #2ecc71">
                    <span
                      class="bring_right glyphicon glyphicon-calendar"
                    ></span>
