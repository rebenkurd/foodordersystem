          ...
          <div class="main_container main_menu_open">
            ...
            <div class="home_pass hidden-xs">
              <ul>
                ...
                <li class="bring_right"><a href="">Categories</a></li>
                <li class="bring_right"><a href="">Add New Category</a></li>
              </ul>
            </div>
            <!--/End system bath-->
              ...
              <div class="form">
                <form class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    >
                    <div class="col-sm-10">
                      <input type="radio" name="Active" id="input3" />
                      Yes
                      <input
                        type="radio"
                        id="input3"
                  ...
                  <div class="form-group">
                    ...
                    >
                    <div class="col-sm-10">
                      <input type="radio" name="Featured" id="input3" />
                      Yes
                      <input
                        type="radio"
                        id="input3"
